...
//         {data.map(card => (
//           <BannerSection key={card._id} card={card} />
//         ))}
//       </div>

//       {/* FAQ */}
//       <div>
//         <motion.h1 className="text-center text-6xl py-3">
...
//       {/* Core Features */}
//       <div>
//         <h1 className="text-center text-6xl py-3">
//           Educoda <span className="text-blue-500">Core</span> Features
//         </h1>
//         <Banner />
//       </div>
//     </div>
