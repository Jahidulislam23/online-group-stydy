...
const Footer = () => {
  ...
  return (
    <footer className="footer footer-horizontal footer-center bg-linear-to-r from-red-200 to-blue-200 rounded p-10">
      <aside>
        <div className="flex gap-3">
          <img
            ...
            alt=""
          />
          <h1 className="p-2 font-bold text-2xl"> Online Group-Study</h1>
        </div>
      ...
      <nav>
        <div className="grid grid-flow-col gap-4">
          ...
          <p>
            ...
            >
              <svg
                xmlns="https://web.facebook.com/?_rdc=1&_rdr#"
                width="24"
                height="24"
                viewBox="0 0 24 24"
                className="fill-current"
