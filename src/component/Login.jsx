...
const Login = () => {
  ...
  <div className="hero-content flex-col lg:flex-row-reverse">
      ...
      <div className="card-body">
        ...
        <div className="my-6 space-y-4">
          ...
          >
            ...
            <button onClick={()=>navigate("/")}><h1 onClick={handleGoogleSignIn}>Login with Google</h1></button>
          </button>
        </div>
        <div className="my-6 space-y-4">
          <button
    ...
    //     <div className="w-full max-w-md p-4 rounded-md mx-auto mt-[50px] shadow sm:p-8 bg-gray-100 text-gray-800">
